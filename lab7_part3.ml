...
let last_el : int = IntListStack.top (small_stack ()) ;;
...
module SafeIntListStack : INT_STACK = (IntListStack : INT_STACK) ;;
...
let safe_stack () = 
  SafeIntListStack.empty
  |> SafeIntListStack.push(5)
  |> SafeIntListStack.push(1)
;;
